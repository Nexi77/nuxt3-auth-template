<template>
    <div class="layout layouf-logged-out">
        <div class="banner">
            <h1>AuthSite</h1>
            <div class="pattern">
...
.banner {
    ...
    align-items: center;
    background: var(--banner-vertical-gradient);
    background-color: var(--clr-primary);
    color: var(--clr-white-400);
    border-bottom-left-radius: calc(var(--base-radius) * 5);
    border-bottom-right-radius: calc(var(--base-radius) * 5);
    min-height: 30vh;
    width: 100%;
    max-width: 1024px;
    margin: 0 auto;
